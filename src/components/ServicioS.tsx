        ...
        <IonGrid>
          <IonRow>
            <IonCol size="12" size-md="6" size-lg="4" className="mb-4">
              <IonCard className="h-80 flex flex-col justify-between shadow-lg rounded-3xl overflow-hidden ease-in duration-300 ... ">
            ...
            <IonCol size="12" size-md="6" size-lg="4" className="mb-4">
              <IonCard className="h-80 flex flex-col justify-between rounded-3xl rounded-lg overflow-hidden ease-in duration-300 ...">
